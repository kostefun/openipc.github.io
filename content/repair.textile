...
p. При ремонте устройств проверяйте керамические SMD конденсаторы (0603/0805) - они часто пробиваются.

p. Для быстрой диагностики работоспособности DC/DC PWM IAELx/MP1470 проверяйте входное напряжение питания на pin2 (~ 10V-12V) и пониженное стабилизированное напряжение на pin3 (~ 4,9V-5,1V). Если на выходе есть указанное напряжение, то скорее всего микросхема работоспособна, а если-же нет то требуется замена. Для проверки работоспособности остальной части платы можно подать +5V 1A от внешнего источника на место пайки pin3, предварительно выпаяв сомнительную микросхему стабилизатора.
